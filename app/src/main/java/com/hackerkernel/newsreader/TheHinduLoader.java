...
/**
 * Created by Rohit Jain on 1/4/2017.
 */

public class TheHinduLoader extends AsyncTaskLoader <List<News>> {
    public TheHinduLoader(Context context) {
        super(context);
    }
    String createStringUrl() {
        ...
        builder.scheme("http")
                ...
                .appendPath("v1")
                .appendPath("articles")
                .appendQueryParameter("source","the-hindu")
